    ...
    <footer className="bg-gray-900 text-gray-400 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 text-lg font-bold text-white mb-3">
              <span className="text-xl">🤖</span> Phu-AI
            </Link>
            <p className="text-xs leading-relaxed">
              Enterprise AI SaaS platform powering the next generation of intelligent workflows.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs">© {new Date().getFullYear()} Phu-AI, Inc. All rights reserved.</p>
